...
public class RequestStageRepositoryTests {
	...
	public void AsaveTest() {
		...
		RequestStage stage = new RequestStage(null, "Foi comprado um novo leptop da Lenovo", new Date(), RequestState.CLOSED, request, owner);
	...
	public void getByIdTest() {
		...
		RequestStage state = result.get();
		
		assertThat(state.getDescription()).isEqualTo("Foi comprado um novo leptop da Lenovo");
	}
